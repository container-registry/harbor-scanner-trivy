...
| `scanner.store.redisScanJobTTL`       | The time to live for persisting scan jobs and associated scan reports. When unset, the scanner derives it from the Trivy timeout (2x timeout + 3s)                                                                                                                                  | ``                                                                       |
